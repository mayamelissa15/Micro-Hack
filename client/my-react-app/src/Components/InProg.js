...
const InProg = ({ title, description ,color }) => {
    ...
    return (  
        <div className="my-4 flex justify-center items-center h-full">
            <div className="w-64 h-64 bg-white rounded-lg shadow-md p-4">
                ...
                <button
        className={` text-xs text-orange-500 font-semibold p-1 px-4 rounded-xl`}
      >
        In progress
      </button>
    ...
    <p className="text-sm font-medium text-orange-600">Complete</p>
</div>
            </div>
        </div>
    );
